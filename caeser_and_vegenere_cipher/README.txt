...
-correlation_of_frequencies.cpp - 
		- Only ciphertext required for cmd argument/s (spaces optional).
...
-caeser_decipher.cpp - 
		...
		- The second argument/s is the ciphertext (spaces optional).
		- Decrypts ciphertext and outputs the plaintext of the caeser cipher.

-index_of_coincidence.cpp -
		-Only ciphertext is required for cmd argument/s (spaces optional).
...
-cipher_splitter.cpp - 
		...
		-Second argument/s is ciphertext (spaces optional).
...
vegenere_decipher.cpp -
		...
		-Second argument/s is the ciphertext (spaces optional).
